...
//____________________________________________________________________________..
ZDCSteppingAction::ZDCSteppingAction(ZDCDetector *detector, const PHParameters *parameters)
...
//____________________________________________________________________________..
ZDCSteppingAction::~ZDCSteppingAction()
{
...
bool ZDCSteppingAction::UserSteppingAction(const G4Step *aStep,bool was_used)
{
...
//____________________________________________________________________________..
void ZDCSteppingAction::SetInterfacePointers(PHCompositeNode *topNode)
{
  ...
  if (!m_HitContainer)
  {
    std::cout << "ZDCSteppingAction::SetTopNode - unable to find "
