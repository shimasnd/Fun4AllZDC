...
//              Based on miniFocal Geometry codes
//

#include "ZDCStructure.h"
#include "constants.h"
#include "zdcdetid.h"
...
void ZDCStructure::ProvideLogicalVolumesSets(std::set<G4LogicalVolume *> &ActiveLogicalVolumesSet,
...
void ZDCStructure::ProvideLogicalVolumeInfoMap(std::map<G4LogicalVolume *, int> &ActiveLogicalVolumeInfoMap){
...
double ZDCStructure::ConstructCrystalTowers(double Start_X, double Start_Y, double Start_Z, 
...
double ZDCStructure::ConstructEMLayers(double Start_X, double Start_Y, double Start_Z, 
			     double End_X, double End_Y, double End_Z,
			     G4VPhysicalVolume *motherPhy) {
...
double ZDCStructure::ConstructHCSiliconLayers(double Start_X, double Start_Y, double Start_Z, 
					    double End_X, double End_Y, double End_Z,
					    G4VPhysicalVolume *motherPhy) {
  double Center_X = (Start_X + End_X)/2.;
  double Center_Y = (Start_Y + End_Y)/2.;
...
double ZDCStructure::ConstructHCSciLayers(double Start_X, double Start_Y, double Start_Z, 
					    double End_X, double End_Y, double End_Z,
					    G4VPhysicalVolume *motherPhy) {
...
void ZDCStructure::Print(){

  std::cout<<"This is ZDCStructure"<<std::endl;

}

void ZDCStructure::SetColors(){
