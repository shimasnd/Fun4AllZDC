...
// Parameter names and defaults are set in ZDCSubsystem::SetDefaultParameters()
...
//____________________________________________________________________________..
ZDCDetector::ZDCDetector(PHG4Subsystem *subsys,
...
int ZDCDetector::IsInDetector(G4VPhysicalVolume *volume) const
{
...
int ZDCDetector::GetVolumeInfo(G4VPhysicalVolume *volume){
...
//_______________________________________________________________
void ZDCDetector::ConstructMe(G4LogicalVolume *logicWorld)
{
 //begin implement your own here://
 // Do not forget to multiply the parameters with their respective CLHEP/G4 unit !
  ...
  ZDCStructure *mzs = new ZDCStructure();
  double endz = 0;
...
//_______________________________________________________________
void ZDCDetector::Print(const std::string &what) const
{
  std::cout << "ZDC Detector:" << std::endl;
